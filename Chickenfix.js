...
secondLine.textContent = "Member - free";
tokenLabel.appendChild(secondLine); 
  ...
  const buttonSelectors = [
	...
	const btnDecorStore = createOrUpdateButton(buttonSelectors[10]);
	...
	invisibleBox.appendChild(btnDecorStore);
	...
	if (btnDecorStore) {
      btnDecorStore.addEventListener("click", () => {
        localStorage.setItem('mapIDS', 'AHinterior');
        clickTelevila();
      });
    }
